# Demographic compensation, SensSurv
# Marco Andrello
...
load(paste0(getwd(),"/Results SensSurv/Results_MPM_SensSurv.RData"))
...
png("Figure_3_corrplot_SensSurv.png",height=15,width=15,units="cm",res=600)
...
save(num.pos.obs,num.neg.obs,num.pos.rand,num.neg.rand,file="Res.numberCorr_SensSurv.RData")

# Plot the histogram
png("Figure_3_Histograms_SensSurv.png",height=15,width=7.5,units="cm",res=300)
...
png(filename="Figure_4_errorbars_SensSurv.png",width=11,height=5.5,units="cm",res=300)
...
png(filename="Figure_4_histogram_SenSurv.png",width=5.5,height=5.5,units="cm",res=300)

# Build and analyse MPM for sensitivity analysis on survival
# Marco Andrello
...
for (i.clim in startclim : endclim) { # Loop on clim
  ...
  for (i.boot in 1 : nboot) {
    ...
    # Load models
    load(paste0(getwd(),"/../../noBackup/Arabis/ResultsGLMM/Models_Clim",i.clim,"_Boot",i.boot,".RData"))
    load(paste0(getwd(),"/../../noBackup/Arabis/ResultsGLMM/SensSurv/Models_Clim",i.clim,"_Boot",i.boot,".RData")) # This will overwrite the surv objects and replace them with the ones accounting for 2009 (sheep trampling)
...
save(nrepl, y,
     ...
     cnet, log.lambda.R,
     file=paste0("Results_MPM_SensSurv_parallel",iparallel,".RData"))

save(mat.G, mat.P, mat.F, mat.K,
      file=paste0("Results_MPM_matrices_SensSurv_parallel",iparallel,".RData"))

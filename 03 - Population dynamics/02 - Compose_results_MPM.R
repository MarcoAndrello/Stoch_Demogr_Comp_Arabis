...
load("Results_MPM_parallel1.RData")
load("Results_MPM_matrices_parallel1.RData")
...
for (i.parallel in 2 : nparallel){
  load(paste0("Results_MPM_matrices_parallel",i.parallel,".RData"))
  load(paste0("Results_MPM_parallel",i.parallel,".RData"))
